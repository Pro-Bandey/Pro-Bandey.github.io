...
import { ExternalLink, Github, CodeXml, Calendar, Sparkles, Star, Share2, Check } from 'lucide-react';
    ...
    <div className="glass-panel group relative flex flex-col h-full overflow-hidden border border-white/10 hover:border-primary/30 bg-white/5 backdrop-blur-md transition-all duration-300">
      ...
      <div className="absolute top-3 right-3 z-10 flex gap-1.5">
        {repo.Stars !== undefined && (
          <div className="bg-black/70 backdrop-blur-md text-amber-400 font-mono text-[10px] px-2 py-0.5 rounded border border-white/10 flex items-center gap-1 shadow-sm">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <h3 
          onClick={() => onOpenReadme(repo.Repo, repo.ReadMeIs)}
          className="text-lg font-mono font-bold text-slate-100 hover:text-primary transition-colors cursor-pointer mb-2 inline-flex items-center gap-1.5"
        >
          {repo.Repo}
        </h3>
